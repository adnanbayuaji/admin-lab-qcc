...
<head>
  ...
  <title>Bluku-Book | Lihat Data Genre</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="genre.php"><i class="fa fa-dashboard"></i>Genre</a></li>
          ...
          <?php
            ...
            while($row = mysql_fetch_array($view))
            {
              ...
              <tr>
                ...
                <td>
                  <?php echo $row['id_genre']; ?>
                </td>
                <td>
                  <?php echo $row['nama']; ?>
                </td>
                <td>
                  <a title="Ubah" href="updategenre.php?id=<?php echo $row['id_genre']; ?>"><i class="fa fa-edit"></i></a>
                  <a title="Hapus" href="../model/genredelete_db.php?id=<?php echo $row['id_genre']; ?>" onclick="return confirm('Anda Yakin untuk Hapus Data?')"><i class="fa fa-trash-o"></i></a>
                </td>
              </tr>
              <?php 
              $baris ++;
