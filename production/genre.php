...
<head>
  ...
  <title>Bluku-Book | Tambah Data Genre</title>
      ...
      <!--------------------------
        ...
        <?php 
          ...
          else
          {
            ...
            {
              list($huruf, $angka) = explode('-', $row['id_genre']);
              $angka = $angka + 1;
              if($angka<10)
              {
        ...
        <div class="box box-info">
          <form onsubmit="return Validasi()" class="form-horizontal" name="formgenre" action="../model/genreinsert_db.php" method="post">
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-2 control-label">Id Genre</label>
                <div class="col-sm-10">
                  <input id="idgenre" type="text" class="form-control" name="idgenre" placeholder="Id Genre" value="<?php echo $hasil; ?>" readonly>
                </div>
              </div>
              <div class="form-group">
