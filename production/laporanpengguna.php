    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        <div class="box box-info">
            <form class="form-horizontal" name="laporanpengguna" action="../model/laporanpengguna_db.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Pencarian Nama dan Id</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" placeholder="Nama dan Id">
                  </div>
                </div>
                <div class="form-group">
