...
<head>
  ...
  <title>Bluku-Book | Lihat Data Pengguna</title>
          ...
          <?php
            ...
            while($row = mysql_fetch_array($view))
            {
              ...
              <tr>
                ...
                <td>
                  <a title="Ubah" href="updatepengguna.php?id=<?php echo $row['id_pengguna']; ?>"><i class="fa fa-edit"></i></a>
                  <a title="Hapus" href="../model/penggunadelete_db.php?id=<?php echo $row['id_pengguna']; ?>" onclick="return confirm('Anda Yakin untuk Hapus Data?')"><i class="fa fa-trash-o"></i></a>
                </td>
              </tr>
              <?php 
              $baris ++;
