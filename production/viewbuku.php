          ...
          <?php
            ...
            while($row = mysql_fetch_array($view))
            {
              ...
              <tr>
                ...
                <td>
                  <?php 
                    $lihat = mysql_query("select * from Genre");
                    while($war = mysql_fetch_array($lihat))
                    {
                      if($row['id_genre']==$war['id_genre'])
                      {
                        echo $war['nama'];
                      }
                    } 
                ...
                <?php 
                  $lihat = mysql_query("select * from Rak");
                  while($war = mysql_fetch_array($lihat))
                  {
                    if($row['id_rak']==$war['id_rak'])
                    {
                      ?>
                      <td>
                      <?php
                ...
                <td>
                  <a title="Ubah" href="updatebuku.php?id=<?php echo $row['id_buku']; ?>"><i class="fa fa-edit"></i></a>
                  <a title="Hapus" href="../model/bukudelete_db.php?id=<?php echo $row['id_buku']; ?>" onclick="return confirm('Anda Yakin untuk Hapus Data?')"><i class="fa fa-trash-o"></i></a>
                </td>
              </tr>
              <?php 
              $baris ++;
