...
<head>
  ...
  <title>Bluku-Book | Edit Data Rak</title>
  ...
  <script type="text/javascript">
    function Validasi()
    {
      ...
      var nobaris = document.getElementById('nobaris').value;
      var nokolom = document.getElementById('nokolom').value;
      var norak = document.getElementById('norak').value;

      var huruf = /^[a-zA-Z]+$/;
      var numbers = /^[0-9]+$/;
      
      if(idrak == "" || nobaris == "" || nokolom == "" || norak == "" )
      {
        alert("Lengkapi data.");
        return false;
      }
      ...
      {
        if(nobaris.match(huruf)||nobaris.match(numbers))
        {
          if(nokolom.match(huruf)||nokolom.match(numbers))
          {
            if(norak.match(huruf)||norak.match(numbers))
            {
              return true;
            }
            else
            {
              alert("Norak harus berupa huruf saja atau angka saja!");
              return false;
            }
          }
          else
          {
            alert("Nokolom harus berupa huruf saja atau angka saja!");
            return false;
          }
        }
        else
        {
          alert("Nobaris harus berupa huruf saja atau angka saja!");
          return false;
        }
      }
    }
        ...
        <!-- Horizontal Form -->
          <?php 
            if(isset($_GET['id']))
            {
              ...
              $select = mysql_query("select * from Rak where id_rak = '$idrak'") or die(mysql_error());
              $sel = mysql_fetch_array($select);
            }
          ?>
          <div class="box box-info">
            <form onsubmit="return Validasi()" class="form-horizontal" name="formrak" action="../model/rakupdate_db.php?id=<?php echo $idrak ?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Id Rak</label>
                  <div class="col-sm-10">
                    <input id="idrak" type="text" class="form-control" name="idrak" placeholder="Id Rak" value="<?php echo $idrak; ?>" readonly>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">No Baris</label>
                  <div class="col-sm-10">
                    <input id="nobaris" type="text" class="form-control" name="nobaris" placeholder="No Baris" value="<?php echo $sel['no_baris']; ?>" >
                  </div>
                </div><div class="form-group">
                  <label class="col-sm-2 control-label">No Kolom</label>
                  <div class="col-sm-10">
                    <input id="nokolom" type="text" class="form-control" name="nokolom" placeholder="No Kolom" value="<?php echo $sel['no_kolom']; ?>" >
                  </div>
                </div><div class="form-group">
                  <label class="col-sm-2 control-label">No Rak</label>
                  <div class="col-sm-10">
                    <input id="norak" type="text" class="form-control" name="norak" placeholder="No Rak" value="<?php echo $sel['no_rak']; ?>" >
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
