...
<head>
  ...
  <title>Bluku-Book | Tambah Data Buku</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        <!-- Horizontal Form -->
        <?php 
          $view = mysql_query("select * from Buku");
          ...
          else
          {
            ...
            {
              list($huruf, $angka) = explode('-', $row['id_buku']);
              $angka = $angka + 1;
              if($angka<10)
              {
         ...
         ?>
          <div class="box box-info">
            <form method="post" onsubmit="return Validasi()" class="form-horizontal" name="formbuku" action="../model/bukuinsert_db.php" id="myform">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Id Buku</label>
                  <div class="col-sm-10">
                    <input id="idbuku" type="text" class="form-control" name="idbuku" placeholder="Id Buku" value="<?php echo $hasil; ?>" readonly>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Judul</label>
                  <div class="col-sm-10">
                    <input id="judul" type="text" class="form-control" name="judul" placeholder="Judul" required>
                  </div>
                </div><div class="form-group">
                  <label class="col-sm-2 control-label">Pengarang</label>
                  <div class="col-sm-10">
                    <input id="pengarang" type="text" class="form-control" name="pengarang" placeholder="Pengarang" onkeypress="return hanyaHuruf(event)" required>
                  </div>
                </div><div class="form-group">
                  <label class="col-sm-2 control-label">Tahun Terbit</label>
                  <div class="col-sm-10">
                    <input id="tahun" type="text" class="form-control" name="tahun" placeholder="Tahun Terbit" onkeypress="return hanyaAngka(event)" required>
                  </div>
                </div><div class="form-group">
                  <label class="col-sm-2 control-label">Nama Genre</label>
                  <div class="col-sm-10">
                    <!--input type="text" class="form-control" name="idgenre" placeholder="ID Genre"-->
                  ...
                  <div class="col-sm-10">
                    <!--input type="text" class="form-control" name="idrak" placeholder="ID Rak"-->
                    <select id="idrak" class="form-control" name="idrak" required>
                      <option>--Pilih Id Rak--</option>
                      <?php
